...
const CONTROLLED_VIEWPORT_ZOOM = 16;
const CONTROLLED_VIEWPORT_BEARING = -25;
const CONTROLLED_VIEWPORT_PITCH = 60;
const INITIAL_VIEWPORT = {
  zoom: CONTROLLED_VIEWPORT_ZOOM,
  bearing: CONTROLLED_VIEWPORT_BEARING,
  pitch: CONTROLLED_VIEWPORT_PITCH,
};
...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  useEffect(() => {
    ...
    const next = {
      ...
      zoom: viewport.zoom ?? CONTROLLED_VIEWPORT_ZOOM,
      bearing: viewport.bearing ?? CONTROLLED_VIEWPORT_BEARING,
      pitch: viewport.pitch ?? CONTROLLED_VIEWPORT_PITCH,
    };
